...
const NarasimhaChaturdashi: React.FC = () => {
  ...
  const slides: Slide[] = [
    {
      ...
      subtitle: "Appearance of Lord Nrisimhadeva",
      description: "Celebrate the divine appearance of Lord Nrisimhadeva, the protector of devotees, who removes all obstacles in devotional service.",
      bgGradient: "from-yellow-400 to-orange-500",
    },
    {
      title: "Seek Protection",
      subtitle: "Maha-Abhisheka & Arati",
      description: "Join the grand maha-abhisheka with sandalwood oil and the auspicious arati to honor Lord Laxmi-Nrisimha.",
      bgGradient: "from-orange-500 to-yellow-400",
    },
    {
      title: "Support the Festival",
      subtitle: "Honor Lord Nrisimhadeva",
      description: "Your contribution helps spread the glories of Lord Nrisimhadeva and His protection for devotees.",
      bgGradient: "from-yellow-400 to-orange-500",
    },
  ];
  ...
  const sevaOptions: SevaOption[] = [
    {
      ...
      description: "Sponsor the maha-abhisheka with sandalwood oil for Lord Laxmi-Nrisimha at dusk",
      price: "",
      bgColor: "bg-yellow-400",
    },
    {
      title: "Prasada Distribution Seva",
      description: "Support the distribution of sumptuous prasada to devotees after the arati",
      price: "",
      bgColor: "bg-yellow-400",
    },
    {
      title: "Deity Dress Sponsorship Seva",
      description: "Sponsor new dress offerings for Lord Laxmi-Nrisimha during the festival",
      price: "",
      bgColor: "bg-yellow-400",
    },
  ];
      ...
      <div className="min-h-screen font-sans bg-[url('https://www.transparenttextures.com/patterns/cream-pixels.png')] bg-orange-50">
        <div className="max-w-6xl mx-auto space-y-8 p-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {/* Left Column: About Narasimha Chaturdashi and Festival Schedule */}
            <div className="md:col-span-2 space-y-6">
              {/* About Narasimha Chaturdashi Card */}
              <Card className="bg-white p-6 rounded-xl shadow-lg border border-yellow-200 transform transition-all duration-500 hover:scale-[1.02] animate-fadeIn">
                <CardContent className="p-0">
                  <div className="flex items-center mb-4">
                    ...
                    <h2 className="text-xl font-bold text-orange-800">About Narasimha Chaturdashi</h2>
                  </div>
                  <p className="text-gray-700 text-sm leading-relaxed">
                    Narasimha Chaturdashi celebrates the appearance of Lord Nrisimhadeva, Krishna’s half-man, half-lion incarnation, who protected His devotee Prahlada Maharaja from the demon Hiranyakashipu. Lord Nrisimhadeva removes obstacles in devotional service, offering protection to devotees who pray to Him, as described in the Srimad-Bhagavatam.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-yellow-50 p-6 rounded-xl shadow-lg border border-yellow-200 transform transition-all duration-500 hover:scale-[1.02] animate-fadeIn animation-delay-200">
                <CardContent className="p-0">
                  ...
                  <div className="space-y-3 text-gray-800 text-sm leading-relaxed">
                    <p><span className="font-bold">At Raipur:</span> 2nd May 2026 (Shukla Chaturdashi, Vaishakha)</p>
                    <p><span className="font-bold">Venue:</span> Hukam’s Lalit Mahal, Naya Raipur Interchange, Serikhedi, Raipur</p>
                    <p><span className="font-bold">Activities:</span> Fasting till dusk, maha-abhisheka with sandalwood oil, grand arati at dusk</p>
                    <p><span className="font-bold">At Bhilai:</span> 2nd May 2026 (Shukla Chaturdashi, Vaishakha)</p>
                    <p><span className="font-bold">Venue:</span> HKM Bhilai Temple, Bhilai</p>
                    <p><span className="font-bold">Activities:</span> Maha-abhisheka, new dress offerings, prasada distribution</p>
                  </div>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="space-y-6">
              {/* Support Narasimha Chaturdashi Card */}
              <Card className="bg-yellow-50 p-6 rounded-xl shadow-lg border border-yellow-200 transform transition-all duration-500 hover:scale-[1.02] animate-fadeIn animation-delay-400">
                <CardContent className="p-0">
                  <h2 className="text-xl font-bold text-orange-800 mb-4">Support Narasimha Chaturdashi</h2>
              ...
              <Card className="bg-yellow-50 p-6 rounded-xl shadow-lg border border-yellow-200 text-center transform transition-all duration-500 hover:scale-[1.02] animate-fadeIn animation-delay-600">
                <CardContent className="p-0">
                  <p className="text-lg font-bold text-gray-800">Festival Date: 2nd May 2026</p>
                  <p className="text-sm text-gray-600 mt-2">Saturday – Shukla Chaturdashi, Vaishakha</p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-yellow-50 p-6 rounded-xl shadow-lg border border-yellow-200 transform transition-all duration-500 hover:scale-[1.02] animate-fadeIn animation-delay-800">
                <CardContent className="p-0">
                  ...
                  <p className="text-gray-700 text-sm leading-relaxed">
                    📞 +91-1234567890<br />
                    ✉️ info@narasimhachaturdashi.org<br />
                    🌐 www.narasimhachaturdashi.org
                  </p>
                </CardContent>
              </Card>
            </div>
            ...
            <CardContent className="p-0">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm text-gray-700">
                <div>
                  ...
                  <p>Sandalwood oil bathing for Lord Laxmi-Nrisimha</p>
                </div>
                <div>
                  <p className="font-bold">Prasada Distribution</p>
                  <p>Sumptuous prasada for devotees</p>
                </div>
                <div>
                  <p className="font-bold">New Dress Offerings</p>
                  <p>Adorning Lord Nrisimhadeva</p>
                </div>
                <div>
                  <p className="font-bold">Grand Arati</p>
                  <p>Auspicious arati at dusk</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-yellow-50 p-6 rounded-xl shadow-lg border border-yellow-200 transform transition-all duration-500 hover:scale-[1.02] animate-fadeIn animation-delay-1200">
            <CardContent className="p-0">
              <h2 className="text-xl font-bold text-orange-800 mb-4">Narasimha Chaturdashi Seva Options</h2>
              <p className="text-gray-600 mb-8 text-center">
                Choose a seva to support the Narasimha Chaturdashi celebrations and seek the protection of Lord Nrisimhadeva
              </p>
                    ...
                    <img
                      ...
                      onError={(e) => {
                        if (e.target instanceof HTMLImageElement) {
                          e.target.src = 'https://via.placeholder.com/600x400?text=Narasimha+Chaturdashi';
                        }
                      }}
                    />
          ...
          <Card id="donation-form" className="bg-yellow-50 p-8 rounded-xl shadow-lg border border-yellow-200 transform transition-all duration-500 hover:scale-[1.02] animate-fadeIn animation-delay-1400">
            <CardContent className="p-0">
              ...
              <DonationForm preselectedCategoryId='sri-narasimha-jayanti'/>
            </CardContent>
          </Card>
