...
const Vaikuntha: React.FC = () => {
  ...
  const slides: Slide[] = [
    {
      ...
      subtitle: "Gateway to Liberation",
      description: "Celebrate the auspicious day dedicated to Lord Vishnu, seeking moksha and eternal bliss.",
      bgGradient: "from-orange-400 to-yellow-500",
    },
    {
      title: "Join the Celebration",
      subtitle: "A Day of Devotion",
      description: "Observe the fast, chant Lord Vishnu’s names, and pass through the Vaikuntha Dwar.",
      bgGradient: "from-yellow-400 to-orange-500",
    },
    {
      title: "Support the Festival",
      subtitle: "Be a Part of Vaikuntha Ekadashi",
      description: "Your contribution helps devotees attain spiritual merit on this sacred day.",
  ...
  const galleryImages: GalleryImage[] = [
    {
      ...
      alt: "Vaikuntha Ekadashi Fasting",
    },
    {
    ...
    },
    {
      ...
      alt: "Vaikuntha Dwar Celebration",
    },
  ];
  ...
  console.log("Vaikuntha component rendered");
      ...
      <div className="min-h-screen font-sans bg-[url('https://www.transparenttextures.com/patterns/cream-pixels.png')] bg-orange-50">
        <div className="max-w-6xl mx-auto space-y-8 p-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {/* Left Column: About Vaikuntha Ekadashi and Festival Schedule */}
            <div className="md:col-span-2 space-y-6">
              {/* About Vaikuntha Ekadashi Card */}
              <Card className="bg-white p-6 rounded-xl shadow-lg border border-yellow-200 transform transition-all duration-500 hover:scale-[1.02] animate-fadeIn">
                <CardContent className="p-0">
                  <div className="flex items-center mb-4">
                    ...
                    <h2 className="text-xl font-bold text-orange-800">About Vaikuntha Ekadashi</h2>
                  </div>
                  <p className="text-gray-700 text-sm leading-relaxed">
                    Vaikuntha Ekadashi, also known as Mokshada Ekadashi, is celebrated on the 11th day of the waxing moon in Margashirsha (December-January). Dedicated to Lord Vishnu, this day opens the gates of Vaikuntha, granting liberation (moksha). Devotees fast, chant Vishnu’s names, and engage in devotional activities, seeking eternal service at His lotus feet.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-yellow-50 p-6 rounded-xl shadow-lg border border-yellow-200 transform transition-all duration-500 hover:scale-[1.02] animate-fadeIn animation-delay-200">
                <CardContent className="p-0">
                  ...
                  <div className="space-y-3 text-gray-800 text-sm leading-relaxed">
                    ...
                    <p><span className="font-bold">Activities:</span> Devotees fast all day, followed by kirtan sessions and a special arati in the evening.</p>
                    <p><span className="font-bold">AT BHILAI:</span> HKM Bhilai Temple, Bhilai</p>
                    <p><span className="font-bold">Activities:</span> Join Vishnu Sahasranama recitations, bhakti discourses, and a grand feast after the fast.</p>
                  </div>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="space-y-6">
              {/* Support Vaikuntha Ekadashi Card */}
              <Card className="bg-yellow-50 p-6 rounded-xl shadow-lg border border-yellow-200 transform transition-all duration-500 hover:scale-[1.02] animate-fadeIn animation-delay-400">
                <CardContent className="p-0">
                  <h2 className="text-xl font-bold text-orange-800 mb-4">Support Vaikuntha Ekadashi</h2>
              ...
              <Card className="bg-yellow-50 p-6 rounded-xl shadow-lg border border-yellow-200 text-center transform transition-all duration-500 hover:scale-[1.02] animate-fadeIn animation-delay-600">
                <CardContent className="p-0">
                  <p className="text-lg font-bold text-gray-800">Festival Date: 21st December 2025</p>
                  <p className="text-sm text-gray-600 mt-2">Sunday – Shukla Paksha Ekadashi</p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-yellow-50 p-6 rounded-xl shadow-lg border border-yellow-200 transform transition-all duration-500 hover:scale-[1.02] animate-fadeIn animation-delay-800">
                <CardContent className="p-0">
                  ...
                  <p className="text-gray-700 text-sm leading-relaxed">
                    📞 +91-1234567890<br />
                    ✉️ info@vaikunthaekadashi.org<br />
                    🌐 www.vaikunthaekadashi.org
                  </p>
                </CardContent>
              </Card>
            </div>
          ...
          <Card className="bg-yellow-50 p-6 rounded-xl shadow-lg border border-yellow-200 transform transition-all duration-500 hover:scale-[1.02] animate-fadeIn animation-delay-1000">
            <CardContent className="p-0">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm text-gray-700">
                <div>
                  <p className="font-bold">Nirjala Fasting</p>
                  <p>Fasting without water until the next morning</p>
                </div>
                <div>
                  <p className="font-bold">Kirtan Sessions</p>
                  <p>Chanting the holy names of Lord Vishnu</p>
                </div>
                <div>
                  <p className="font-bold">Vaikuntha Dwar</p>
                  <p>Symbolic entry into Lord Vishnu’s abode</p>
                </div>
                <div>
                  <p className="font-bold">Temple Decorations</p>
                  <p>Adorned with flowers, lamps, and rangolis</p>
                </div>
              </div>
            </CardContent>
          </Card>
                    ...
                    <img
                      ...
                      onError={(e) => {
                        if (e.target instanceof HTMLImageElement) {
                          e.target.src = 'https://via.placeholder.com/600x400?text=Vaikuntha+Ekadashi';
                        }
                      }}
                    />
