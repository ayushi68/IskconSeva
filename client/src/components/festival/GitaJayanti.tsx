  ...
  const slides: Slide[] = [
    {
      ...
      description: "Celebrate the divine moment when Lord Krishna spoke the eternal teachings of the Bhagavad Gita to Arjuna.",
      bgGradient: "from-yellow-400 to-orange-500",
    },
    {
      title: "Join the Celebration",
      subtitle: "Recitation & Abhisheka",
      description: "Participate in Gita recitation, cultural programs, and the grand Sri Sri RadhaKrishna Maha Abhisheka.",
      bgGradient: "from-orange-500 to-yellow-400",
    },
    {
      title: "Support the Festival",
      subtitle: "Spread Krishna’s Wisdom",
      description: "Your contribution helps promote the timeless teachings of the Bhagavad Gita.",
      bgGradient: "from-yellow-400 to-orange-500",
    },
  ];
  ...
  const sevaOptions: SevaOption[] = [
    {
      ...
      description: "Sponsor the Sri Sri RadhaKrishna Maha Abhishek ceremony during Gita Jayanti",
      price: "",
      bgColor: "bg-yellow-400",
    },
    {
      title: "Feast Sponsorship Seva",
      description: "Support the sumptuous feast for thousands of devotees celebrating Gita Jayanti",
      price: "",
      bgColor: "bg-yellow-400",
    },
    {
      title: "Cultural Program Sponsorship Seva",
      description: "Sponsor cultural programs that glorify the teachings of the Bhagavad Gita",
      price: "",
      bgColor: "bg-yellow-400",
    },
  ];
      ...
      <div className="min-h-screen font-sans bg-[url('https://www.transparenttextures.com/patterns/cream-pixels.png')] bg-orange-50">
        <div className="max-w-6xl mx-auto space-y-8 p-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {/* Left Column: About Gita Jayanti and Festival Schedule */}
            <div className="md:col-span-2 space-y-6">
              {/* About Gita Jayanti Card */}
              <Card className="bg-white p-6 rounded-xl shadow-lg border border-yellow-200 transform transition-all duration-500 hover:scale-[1.02] animate-fadeIn">
                <CardContent className="p-0">
                  <div className="flex items-center mb-4">
                    ...
                    <h2 className="text-xl font-bold text-orange-800">About Gita Jayanti</h2>
                  </div>
                  <p className="text-gray-700 text-sm leading-relaxed">
                    Gita Jayanti commemorates the divine moment when Lord Krishna imparted the eternal wisdom of the Bhagavad Gita to Arjuna. Celebrated on the Ekadashi of Margashirsha, devotees recite the Gita, perform abhisheka, and engage in cultural programs to honor Krishna’s teachings.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-yellow-50 p-6 rounded-xl shadow-lg border border-yellow-200 transform transition-all duration-500 hover:scale-[1.02] animate-fadeIn animation-delay-200">
                <CardContent className="p-0">
                  ...
                  <div className="space-y-3 text-gray-800 text-sm leading-relaxed">
                    <p><span className="font-bold">At Raipur:</span> 5th December 2025</p>
                    ...
                    <p><span className="font-bold">At Bhilai:</span> 5th December 2025</p>
            ...
            <div className="space-y-6">
              ...
              <Card className="bg-yellow-50 p-6 rounded-xl shadow-lg border border-yellow-200 transform transition-all duration-500 hover:scale-[1.02] animate-fadeIn animation-delay-400">
                <CardContent className="p-0">
                  <h2 className="text-xl font-bold text-orange-800 mb-4">Support Gita Jayanti</h2>
              ...
              <Card className="bg-yellow-50 p-6 rounded-xl shadow-lg border border-yellow-200 text-center transform transition-all duration-500 hover:scale-[1.02] animate-fadeIn animation-delay-600">
                <CardContent className="p-0">
                  <p className="text-lg font-bold text-gray-800">Festival Date: 5th December 2025</p>
          ...
          <Card className="bg-yellow-50 p-6 rounded-xl shadow-lg border border-yellow-200 transform transition-all duration-500 hover:scale-[1.02] animate-fadeIn animation-delay-1000">
            <CardContent className="p-0">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm text-gray-700">
                <div>
                  <p className="font-bold">Gita Recitation</p>
                  <p>Chanting the sacred verses</p>
                </div>
                <div>
                  <p className="font-bold">Maha Abhisheka</p>
                  <p>Grand bathing of deities</p>
                </div>
                <div>
                  <p className="font-bold">Cultural Programs</p>
                  <p>Glorifying Gita’s teachings</p>
                </div>
                <div>
          ...
          <Card className="bg-yellow-50 p-6 rounded-xl shadow-lg border border-yellow-200 transform transition-all duration-500 hover:scale-[1.02] animate-fadeIn animation-delay-1200">
            <CardContent className="p-0">
              <h2 className="text-xl font-bold text-orange-800 mb-4">Gita Jayanti Seva Options</h2>
              <p className="text-gray-600 mb-8 text-center">
                Choose a seva to support the Gita Jayanti celebrations and spread the wisdom of the Bhagavad Gita
              </p>
                    ...
                    <img
                      ...
                      onError={(e) => {
                        if (e.target instanceof HTMLImageElement) {
                          e.target.src = 'https://via.placeholder.com/600x400?text=Gita+Jayanti';
                        }
                      }}
                    />
          ...
          <Card id="donation-form" className="bg-yellow-50 p-8 rounded-xl shadow-lg border border-yellow-200 transform transition-all duration-500 hover:scale-[1.02] animate-fadeIn animation-delay-1400">
            <CardContent className="p-0">
              ...
              <DonationForm preselectedCategoryId='gita-jayanti'/>
            </CardContent>
          </Card>
