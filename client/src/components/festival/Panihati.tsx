...
const Panihati: React.FC = () => {
  const [currentSlide, setCurrentSlide] = useState<number>(0);
  const [selectedImage, setSelectedImage] = useState<string | null>(null);

  const slides: Slide[] = [
    {
      title: "Cida-dahi Mahotsav",
      subtitle: "The Chipped Rice Festival",
      description: "Celebrate the divine pastimes of Lord Nityananda Prabhu and Srila Raghunatha dasa Goswami with a grand feast of yoghurt and chipped rice.",
      bgGradient: "from-yellow-400 to-orange-500",
    },
    {
      title: "Join the Ecstasy",
      subtitle: "Feast and Kirtan",
      description: "Experience the joy of sankirtana and the divine mercy of Lord Nityananda at Panihati’s sacred festival.",
      bgGradient: "from-orange-500 to-yellow-400",
    },
    {
      title: "Support the Festival",
      subtitle: "Honor the Divine Pastimes",
      description: "Your contribution helps spread the glories of the Cida-dahi Mahotsav and Lord Nityananda’s mercy.",
      bgGradient: "from-yellow-400 to-orange-500",
    },
  ];
  ...
  const galleryImages: GalleryImage[] = [
    ...
    },
    {
      ...
      alt: "Panihati Procession",
    },
  ];

  const sevaOptions: SevaOption[] = [
    {
      title: "Prasadam Feast Sponsorship Seva",
      description: "Sponsor the grand prasadam feast of yoghurt and chipped rice for the devotees",
      price: "",
      bgColor: "bg-yellow-400",
    },
    {
      title: "Kirtan Sponsorship Seva",
      description: "Support the ecstatic kirtan in honor of Lord Nityananda Prabhu and Srila Raghunatha dasa Goswami",
      price: "",
      bgColor: "bg-yellow-400",
    },
    {
      title: "Festival Decoration Seva",
      description: "Sponsor decorations to honor the divine pastimes at the Cida-dahi Mahotsav",
      price: "",
      bgColor: "bg-yellow-400",
    },
  ];
      ...
      <div className="min-h-screen font-sans bg-[url('https://www.transparenttextures.com/patterns/cream-pixels.png')] bg-orange-50">
        <div className="max-w-6xl mx-auto space-y-8 p-6">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            {/* Left Column: About Cida-dahi Mahotsav and Festival Schedule */}
            <div className="md:col-span-2 space-y-6">
              {/* About Cida-dahi Mahotsav Card */}
              <Card className="bg-white p-6 rounded-xl shadow-lg border border-yellow-200 transform transition-all duration-500 hover:scale-[1.02] animate-fadeIn">
                <CardContent className="p-0">
                  <div className="flex items-center mb-4">
                    ...
                    <h2 className="text-xl font-bold text-orange-800">About Cida-dahi Mahotsav</h2>
                  </div>
                  <p className="text-gray-700 text-sm leading-relaxed">
                    The Cida-dahi Mahotsav, also known as the Chipped Rice Festival of Panihati, celebrates the divine pastimes of Srila Raghunatha dasa Goswami and Lord Nityananda Prabhu. Held on the banks of the Ganges at Panihati, this festival commemorates Lord Caitanya’s mercy through a grand feast of yoghurt and chipped rice, arranged by Lord Nityananda and Raghunatha dasa. Also known as Danda Mahotsava (the Festival of Punishment), it culminates in a shared prasadam feast.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-yellow-50 p-6 rounded-xl shadow-lg border border-yellow-200 transform transition-all duration-500 hover:scale-[1.02] animate-fadeIn animation-delay-200">
                <CardContent className="p-0">
                  ...
                  <div className="space-y-3 text-gray-800 text-sm leading-relaxed">
                    <p><span className="font-bold">At Raipur:</span> 2nd June 2025</p>
                    <p><span className="font-bold">Venue:</span> Hukam’s Lalit Mahal, Naya Raipur Interchange, Serikhedi, Raipur</p>
                    <p><span className="font-bold">Time:</span> Celebrations start at 7:30 PM, culminating with a grand prasadam feast</p>
                    <p><span className="font-bold">At Bhilai:</span> 2nd June 2025</p>
                    <p><span className="font-bold">Venue:</span> HKM Bhilai Temple, Bhilai</p>
                    <p><span className="font-bold">Activities:</span> Ecstatic feast and kirtan honoring Srila Raghunatha dasa Goswami and Lord Nityananda</p>
                  </div>
                </CardContent>
              </Card>
            </div>
            ...
            <div className="space-y-6">
              {/* Support Cida-dahi Mahotsav Card */}
              <Card className="bg-yellow-50 p-6 rounded-xl shadow-lg border border-yellow-200 transform transition-all duration-500 hover:scale-[1.02] animate-fadeIn animation-delay-400">
                <CardContent className="p-0">
                  <h2 className="text-xl font-bold text-orange-800 mb-4">Support Cida-dahi Mahotsav</h2>
              ...
              <Card className="bg-yellow-50 p-6 rounded-xl shadow-lg border border-yellow-200 text-center transform transition-all duration-500 hover:scale-[1.02] animate-fadeIn animation-delay-600">
                <CardContent className="p-0">
                  <p className="text-lg font-bold text-gray-800">Festival Date: 2nd June 2025</p>
                  <p className="text-sm text-gray-600 mt-2">Monday</p>
                </CardContent>
              </Card>
          ...
          <Card className="bg-yellow-50 p-6 rounded-xl shadow-lg border border-yellow-200 transform transition-all duration-500 hover:scale-[1.02] animate-fadeIn animation-delay-1000">
            <CardContent className="p-0">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm text-gray-700">
                <div>
                  <p className="font-bold">Prasadam Feast</p>
                  <p>Grand feast of yoghurt and chipped rice</p>
                </div>
                <div>
                  <p className="font-bold">Ecstatic Kirtan</p>
                  <p>Chanting in honor of Lord Nityananda</p>
                </div>
                <div>
                  <p className="font-bold">Festival Decorations</p>
                  <p>Honoring the divine pastimes</p>
                </div>
                <div>
                  <p className="font-bold">Danda Mahotsava</p>
                  <p>Commemorating the Festival of Punishment</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-yellow-50 p-6 rounded-xl shadow-lg border border-yellow-200 transform transition-all duration-500 hover:scale-[1.02] animate-fadeIn animation-delay-1200">
            <CardContent className="p-0">
              <h2 className="text-xl font-bold text-orange-800 mb-4">Cida-dahi Mahotsav Seva Options</h2>
              <p className="text-gray-600 mb-8 text-center">
                Choose a seva to support the Cida-dahi Mahotsav and honor the pastimes of Lord Nityananda Prabhu
              </p>
                    ...
                    <img
                      ...
                      onError={(e) => {
                        if (e.target instanceof HTMLImageElement) {
                          e.target.src = 'https://via.placeholder.com/600x400?text=Cida-dahi+Mahotsav';
                        }
                      }}
                    />
          ...
          <Card id="donation-form" className="bg-yellow-50 p-8 rounded-xl shadow-lg border border-yellow-200 transform transition-all duration-500 hover:scale-[1.02] animate-fadeIn animation-delay-1400">
            <CardContent className="p-0">
              ...
              <DonationForm preselectedCategoryId='panihati-chida-dahi-mahotsava'/>
            </CardContent>
          </Card>
