        ...
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://wa.me/YourNumber" className="text-white hover:text-secondary transition" aria-label="WhatsApp">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-300 hover:text-secondary transition">Offer Seva</a></li>
              <li><a href="#" className="text-gray-300 hover:text-secondary transition">Festivals</a></li>
              ...
              <li><a href="#" className="text-gray-300 hover:text-secondary transition">Blogs</a></li>
            </ul>
          </div>
