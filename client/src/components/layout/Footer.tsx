...
export default function Footer() {
  ...
  try {
    ...
    if (res.ok) {
      ...
      setFormData({ name: "", mobile: "", email: "", dob: "" });
    } else {
      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div>
            ...
            <p className="text-gray-300 mb-3 text-justify">Joy can only be experienced when we offer our love to Krishna.
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/terms-and-services">
                  <a className="text-gray-300 hover:text-secondary transition">Terms & Conditions</a>
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/donation-cancel">
                  <a className="text-gray-300 hover:text-secondary transition">Cancellation & Refund Policy</a>
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/Donation">
                  <a className="text-gray-300 hover:text-secondary transition">Offer Seva</a>
                </Link>
              </li>
              <li>
                <Link href="/Festival">
                  <a className="text-gray-300 hover:text-secondary transition">Festivals</a>
                </Link>
              </li>
              <li>
                <Link href="/Activitieslp">
                  <a className="text-gray-300 hover:text-secondary transition">Activities</a>
                </Link>
              </li>
              <li>
                <Link href="/temple/Tsbhilai">
                  <a className="text-gray-300 hover:text-secondary transition">Temple Schedule</a>
                </Link>
              </li>
              <li>
                <Link href="/all-events">
                  <a className="text-gray-300 hover:text-secondary transition">Vaishnava Calendar</a>
                </Link>
              </li>
              <li>
                <Link href="/Bloglp">
                  <a className="text-gray-300 hover:text-secondary transition">Blogs</a>
                </Link>
                </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Would you like to stay informed about our upcoming events, temple updates and more?
            </p>
        ...
        <div className="relative px-6 py-4 mx-auto w-[95%] md:w-[85%] xl:w-[80%] bg-white border-t border-gray-300 rounded-t-xl shadow-lg text-gray-700 text-sm flex flex-col md:flex-row items-center justify-between">
          ...
          <p className="text-center md:text-left mt-0">
            &copy; {new Date().getFullYear()} ISKCON Bhilai. All rights reserved.
          </p>
          <p className="text-center md:text-right mt-2 md:mt-0">
            Read our <span className="underline cursor-pointer">Terms & Conditions</span> and <span className="underline cursor-pointer">Privacy Policy</span>
          </p>
        </div>
      </div>
    </footer>
