  ...
  return (
    <div className="bg-white text-gray-800">
      ...
      <section className="bg-blue-100 py-16 px-6 text-center">
        ...
        <p className="max-w-3xl mx-auto text-lg md:text-xl text-blue-700">
          Prabhupāda: Let them remain, family life, but understand what is Kṛṣṇa consciousness. That's all. We never condemn family life. Chant Hare Kṛṣṇa anywhere. That's all.
            <br />Nowhere in the Vedic Literature it is found that only sannyasīs, or those who serve Krishna full time or in a Temple will go back home back to Godhead. But instead Lord Says in Bhagavad Gītā: 
        </p>
      </section>
        ...
        <div className="grid gap-8 max-w-5xl mx-auto">
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            <p className="text-gray-700">
             "In every town and village on the earth, the chanting of My name will be heard."<br />
             Irrespective of whether the soul is in the body of a brāhmaṇa or a vaishya, brahmacharī or a grihastha, the Laws of Nature will act sameway and if at the testing time, at the moment of death, we can chant  the Holy Names of Lord Krishna, then we go back to home, back to Godhead.<br />

            The Goal of establishing so many Temples and initiating so many disciples etc, done by Prabhupāda were all aimed at making everyone irrespective of caste, creed, gender, chant the Holy name of Krishna and as mentioned in the beginning, convert every home into a Temple.
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-2xl font-bold text-blue-700 mb-4">Practicing Krishna Consciousness</h3>
            <p className="text-gray-700">
              Śrila Prabhupāda says: Without Krishna consciousness, everyone must suffer. That is the law of nature. Daivī hy esā gunamayī mama māyā duratyayā [Bg. 7.14]. You cannot avoid it. Mām eva ye prapadyante māyām etām taranti te [Bg. 7.14]. You can be happy only when you are a surrendered soul to Krishna. That is the only way. 
            Spiritual life might seem quite utopian and challenging, but it reduces our anxiety, adds up happiness to whatever we do thus ensuring a peaceful and blessed life of the aspirant. Dovetailing every activity in service of Krishna is the only change that has to be brought in and automatically, without our intervention, the Lord will take care of the coming chapters of our life…
            Human birth is a rare gift and blessing by Lord Krishna. Durlabham manusham janma.. If it is not utilized in the service of The Lord and is wasted for gratifying our senses, it is a great loss. One of the twelve Mahājanās, Śri Prahlād Maharaj says:
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            <p className="text-gray-700">
             Prahlāda Mahārāja said: One who is sufficiently intelligent should use the human form of body from the very beginning of life — in other words, from the tender age of childhood — to practice the activities of devotional service, giving up all other engagements. The human body is most rarely achieved, and although temporary like other bodies, it is meaningful because in human life one can perform devotional service. Even a slight amount of sincere devotional service can give one complete perfection, svalpam api asya dharmasya trāyate mahato bhayāt.

            The activities done in material life can be spiritualized by doing them for Krishna, for example, cooking food for Krishna, reading books on Krishna, offering the fruits of our work/job/ in service of Krishna and his devotees etc. But all this has to be done under the guidance of Sādhu, Śastra (scriptures) and Guru (Spiritual master). The guidance has to be accepted from these authorities. Without following the instructions of a spiritual master who is in an authorized chain of disciplic succession, we cannot make spiritual progress. 
            Gaining knowledge on the principles and practices of Krishna Consciousness and applying them in real life, brings us closer to God, or Krishna. Krishna says in the Bhagavad-gītā (18.55), bhaktyā māṁ abhijānāti: “I can be known only by devotional service.” Knowledge guides us in proper action. Spiritual knowledge directs us to satisfy the desires of Krishna through practical engagements in His loving service. Without practical application, theoretical knowledge is of little value.
            We should try to do our best, to do more than is simply convenient. Then it will be possible for us to rise to the transcendental plane of Krishna consciousness, even while living far from a temple.The practices outlined here are the timeless practices of bhakti-yoga as given by the foremost spiritual master and exponent of Krishna consciousness in our time, His Divine Grace A.C. Bhaktivedanta Swami Prabhupāda, founder-ācārya of the International Society for Krishna Consciousness (ISKCON).
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-2xl font-bold text-blue-700 mb-4">Chanting the Hare Krishna Mahamantra</h3>
            <p className="text-gray-700">
            ...
            <br />
            “O energy of the Lord [Hare], O all-attractive Lord [Krishna], O Supreme Enjoyer [Rāma], please engage me in Your service.”
            <br />
            ...
            (Srila Prabhupada on importance of chanting)
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            As Lord Caitanya said, “There are no hard and fast rules for chanting Hare Krishna.”, we request you to take this most sublime process and get benefited.
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md">
            ...
            Setting up an altar at home means receiving the Lord and His pure devotees as your most honored guests. An ideal place to set up an altar would be clean, well lit, (well decorated if possible) and free from drafts and household disturbances. A wall shelf, a mantelpiece, a corner table, or the top shelf of a bookcase will do for an altar. Make your altar accessible, by which daily you can worship Their Lordships and also you can chant sitting in front of the Altar.<br />
            <h3>What do you need for an altar? Here are the essentials:</h3>
            <ul className="list-disc list-inside">
              <li> A picture of Śrīla Prabhupāda.</li>
              <li>A picture of Lord Caitanya and His associates.</li>
              <li>A picture of Sri Sri Radha Krishna.</li>
            </ul>
            <p className="mt-2">
          ...
          <div className="bg-white p-6 rounded-lg shadow-md">
           ...
           “Just as Rādhā is dear to Lord Kṛsṇa, so Her bathing place [Rādhā-kuṇḍa] is dear to Him. She alone is His most beloved of all the gopīs.” 
            ...
            Mām eva ye prapadyante māyām etām taranti te [Bg. 7.14]. You can be happy only when you are a surrendered soul to Krishna. That is the only way. Harim vinā na mrtim taranti. Spiritual life might seem difficult but is very easy, sublime and most rewarding. If you try to love God, you’ll gradually realize how much He loves you. That’s the essence of bhakti-yoga.
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-2xl font-bold text-blue-700 mb-4">Prasādam: How to Eat Spiritually</h3>
            <p className="text-gray-700">
            ...
            With this and in many other Vedic Scriptures, prasādam is given much importance. Spiritualizing the senses instead of suppressing them, like done in other yogas, is much easier and sublime and relieves us from various sufferings.<br />
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md">
           ...
           If one offers Me with love and devotion a leaf, a flower, a fruit or water, I will accept it.
            ...
            Once the items are prepared then:<br/>
            1. Arrange portions of the food on dinnerware kept especially for this purpose; no one but the Lord should eat from these dishes.<br />
            2. You must then place Tulasi leaves on all  food items.<br />
            3. Do not forget to keep drinking water on the plate<br />
            4. Now keep the plate in the altar or in front of the altar. Close the altar curtain or shield the offering so it is not visible to us. Ive a doubt??<br />
            5.Now chant below prayers. The easiest way to offer food is simply to pray, “My dear Lord Kṛṣṇa, please accept this food,” and to chant each of the following prayers three times while ringing a bell:<br />
            <ul>
                <li> Prayer to Śrīla Prabhupāda:<br />
                nama oṁ viṣṇu-pādāya kṛṣṇa-preṣṭhāya bhū-tale<br />
                śrīmate bhaktivedānta-svāmin iti nāmine<br />
                namas te sārasvate deve gaura-vāṇī-pracāriṇe<br />
           ...
           <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-2xl font-bold text-blue-700 mb-4">Everyday Life: The Four Regulative Principles</h3>
            <p className="text-gray-700">
            ...
            Avoid the following four sinful activities:<br />
            1. Eating meat, fish, eggs, onion, garlic, mushrooms etc should be avoided. These foods are saturated with the modes of passion and ignorance and therefore cannot be offered to the Lord. A person who eats these foods participates in a conspiracy of violence against helpless animals and thus stops his spiritual progress dead in its tracks.<br />
            2. Gambling. Gambling invariably puts one into anxiety and fuels greed, envy, and anger.<br />
            3. The use of intoxicants. Drugs, alcohol, and tobacco, as well as any drinks or foods containing caffeine, cloud the mind, overstimulate the senses, and make it impossible to understand or follow the principles of bhakti-yoga.<br />
            4. Illicit sex. This is sex outside of marriage or sex in marriage for any purpose other than procreation. Sex for pleasure compels one to identify with the body and takes one far from Krishna consciousness. The scriptures teach that sex is the most powerful force binding us to the material world. Anyone serious about advancing in Krishna consciousness should minimize sex or eliminate it entirely.<br />
            </p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md">
            <h3 className="text-2xl font-bold text-blue-700 mb-4">Engagement in Practical Devotional Service</h3>
            <p className="text-gray-700">
            I am glad that you have decided to give your time now fully to serving Krsna directly, but do not misunderstand the position of "outside" jobs. Any work which is performed by a devotee in Krsna Consciousness is never work on the material platform although it may appear to be so. Such a Krsna Conscious person is never associating with the materials of mundane work or with the mundane workers, he is always associating with Krsna by devotional service whatever his position may be.
 						             (Letter to Krsnakanti written from Bombay November 29, 1970)<br />
            That is the mercy of a Spiritual Master, who accepts our countless faults, but instructs and guides us how we can become Krishna Conscious all the time. Thus the karmic reactions which we may be about to face, could be reduced..<br />
