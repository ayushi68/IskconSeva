...
const DivineCouple = () => {
  return (
    <div className="flex flex-col items-center bg-gradient-to-b from-rose-50 to-pink-100 text-gray-800 font-serif">
      {/* Hero Section */}
      <div className="relative w-full h-[500px] overflow-hidden">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center">
          <h1 className="text-5xl md:text-6xl text-white font-bold drop-shadow-lg animate-fade-in">
            Divine Couple
          </h1>
        </div>
      </div>
      ...
      {/* Intro */}
      <div className="max-w-4xl px-6 py-10 text-lg leading-relaxed text-center animate-fade-in">
        <p>
          Śrī Kṛṣṇa (the all-attractive) is Madana-Mohana, the enchanter of Cupid and Śrīmatī Rādhārāṇī is Madana-mohana-mohini, enchanter of that enchanter of Cupid…..
        </p>
        <p className="mt-2 text-right italic text-sm">
          (Nectar Of Instruction 10, Purport)
        </p>
      </div>

      <div className="max-w-4xl px-6 py-10 text-lg space-y-6 animate-fade-in">
        <p>Exploring, through the scriptures, we find many verses, appreciating the Divine Couple and their love for each other. Here are a few lines from a delightful poem on the Divine Couple, by the great Vaishnav poet and Acharya, Srila Narottam Das Thakur.</p>
      </div>
      ...
      {/* Slogan / Poem Boxes */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl px-6 py-10 animate-fade-in">
        <div className="bg-white/80 p-6 rounded-3xl shadow-2xl backdrop-blur-md">
          <h2 className="text-xl font-semibold text-rose-700 mb-4">
            Poem by Srila Narottam Das Thakur
          </h2>
          <p>
            (2)<br />
        ...
        <div className="bg-rose-100/90 p-6 rounded-3xl shadow-2xl backdrop-blur-md">
          <h2 className="text-xl font-semibold text-rose-900 mb-4">Translation</h2>
          <p>
            2) In the center of the lotus is a golden platform surrounded by eight petals. On these petals reside the eight principal gopis, and in the center Lord Syamasundara and the beautiful Srimati Radharani sit on a jewel throne.
          </p>
          <p className="mt-4">
            3) Their divine beauty, laughter, and playful talks shower nectar. Narottama Dasa prays that these blissful eternal pastimes always stay in his heart.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-4xl px-6 py-10 text-lg space-y-6 animate-fade-in">
        ...
        <h1>In Chaitanya Charitamrita, it is stated (CC Madhya 8.182):</h1>
        <p>
      ...
      <div className="bg-white max-w-4xl px-6 py-10 mb-14 rounded-3xl shadow-xl text-center space-y-6 animate-fade-in">
        <div>
    ...
    <div className="max-w-4xl px-6 py-10 text-lg space-y-6 animate-fade-in">
      ...
      <div className="bg-white max-w-4xl px-6 py-10 mb-14 rounded-3xl shadow-xl text-center space-y-6 animate-fade-in">
        ...
        <div className="pt-6 border-t border-rose-300">
          <p className="italic text-rose-700">
            rādhā-kṛṣṇa prāṇa mora jugala-kiśora<br />
          ...
          <p className="mt-2 text-right italic text-sm">
          (rādhā-kṛṣṇa prāṇa mora jugala-kiśora song by Narottam Dasa Thakura)
        </p>
        </div>
      </div>
    </div>
