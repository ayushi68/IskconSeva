...
const BhaktiYoga: React.FC = () => {
  return (
    <div className="bg-white text-gray-800">
      {/* Hero Section */}
      <section className="bg-gradient-to-r from-pink-100 to-yellow-100 py-12">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-5xl font-bold text-pink-700 mb-4">Bhakti Yoga</h1>
      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-semibold text-center text-pink-600 mb-8">Practicing</h2>
      ...
      <section className="bg-pink-50 py-12">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-semibold text-center text-pink-600 mb-8">Bhakti</h2>
          <div className="grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="order-1 md:order-2">
              ...
              <p className="mt-4">
                <strong><u>Śrīmad Bhāgavataṃ 9.4.18-21: Mahārāja Ambarīṣa</u></strong> always engaged his mind in meditating upon the lotus feet of <b>Kṛṣṇa</b>, his <b>words in describing the glories of the Lord, his hands in cleansing the Lord’s temple, and his ears in hearing the words spoken by Kṛṣṇa or about Kṛṣṇa. He engaged his eyes in seeing the Deity of Kṛṣṇa, Kṛṣṇa’s temples and Kṛṣṇa’s places like Mathurā and Vṛndāvana, he engaged his sense of touch in touching the bodies of the Lord’s devotees, he engaged his sense of smell in smelling the fragrance of tulasī offered to the Lord, and he engaged his tongue in tasting the Lord’s prasāda. He engaged his legs in walking to the holy places and temples of the Lord, his head in bowing down before the Lord, and all his desires in serving the Lord, twenty-four hours a day.</b> Indeed, Mahārāja Ambarīṣa never desired anything for his own sense gratification. He engaged all his senses in devotional service, in various engagements related to the Lord. This is the way to increase attachment for the Lord and be completely free from all material desires. In performing his prescribed duties as king, Mahārāja Ambarīṣa always offered the results of his royal activities to the Supreme Personality of Godhead, Kṛṣṇa, who is the enjoyer of everything and is beyond the perception of material senses. 
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-12">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-semibold text-center text-pink-600 mb-8">Yoga</h2>
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <p className="mb-4">
      ...
      <section className="py-12">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-3xl font-semibold text-pink-600 mb-4">Embrace the Path of Bhakti Yoga</h2>
          <p className="max-w-2xl mx-auto">
            ...
            All these practices might seem quite difficult and uninteresting due to the influence of Kali Yuga upon us and we are all considered mandabhāgyās, unfortunate people.. But Krishna’s mercy knows no bounds and hence he invests all his potencies in his Holy Name: 
          </p>
        </div>
        <h2 className='text-center'>Śrīmad-Bhāgavatam (Bhāgavata Purāṇa) 12.3.51</h2>
        ...
        <p className='text-center'>My dear King, although Kali-yuga is an ocean of faults, there is still one good quality about this age:<br /> Simply by chanting the Hare Kṛṣṇa mahā-mantra, one can become free from material bondage and be promoted to the transcendental kingdom.</p>
      </section>
    </div>
  );
};
