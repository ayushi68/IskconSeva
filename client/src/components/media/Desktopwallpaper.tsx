...
const wallpapers2025 = [
	{
		...
		description:
			"Beautiful calendar featuring Krishna's winter patterns with devotional quotes.",
	...
	},
	{
		...
		title: "Divine Love",
		description:
			"Radha Krishna theme celebrating divine love with February calendar dates.",
		resolution: "1920×1080",
	...
	},
	{
		...
		title: "Holi Festival",
		description:
			"Vibrant Holi celebration with Krishna playing with colors and spring calendar.",
		resolution: "1920×1080",
...
export default function Desktopwallpaper() {
	const [activeFilter, setActiveFilter] =
		useState<"all" | "2025" | "2024" | "calendar">("all");
	...
	const filteredWallpapers2025 =
		activeFilter === "all" || activeFilter === "2025" || activeFilter === "calendar"
			? wallpapers2025
			: [];
	const filteredWallpapers2024 =
		activeFilter === "all" || activeFilter === "2024" || activeFilter === "calendar"
			? wallpapers2024
			: [];
	...
	return (
		<div className="bg-gradient-to-b from-amber-50 via-amber-100 to-white min-h-screen pb-20">
			{/* Header Section */}
			<div className="bg-[url('')] bg-cover bg-center text-white text-center py-20 px-4 relative">
				<div className="absolute inset-0 bg-gradient-to-b from-black/50 to-transparent"></div>
				<div className="relative">
					<h1 className="text-5xl font-extrabold tracking-tight">
						Sacred{" "}
						<span className="text-yellow-400">Desktop</span> Wallpapers
					</h1>
					...
					<p className="text-sm mt-2 font-medium text-yellow-200">
			...
			<div className="max-w-7xl mx-auto px-4 mt-12">
				...
				{filteredWallpapers2025.length > 0 && (
					<>
						<h2 className="text-center mt-16 text-2xl font-semibold text-gray-800 tracking-tight">
							2025 Collection
						</h2>
							...
							{filteredWallpapers2024.map((wallpaper, index) => (
								...
								>
									...
									<CardContent className="p-4">
										...
										<h4 className="text-sm font-semibold text-gray-800 mt-2 mb-3">
											{wallpaper.title}
										</h4>
